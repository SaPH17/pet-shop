                    ...
                    <div class="mx-5 w-100">
                        ...
                        <form action="{{ route('category.update', compact('category')) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="my-4 w-full form-input @error('name') is-invalid @enderror" name="name" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="image" type="file" class="my-4 w-full form-input @error('image') is-invalid @enderror" name="image" required>
                                </div>
                            </div>
